...
const images = [
  ...
  { src:  "/images/ngo_pr/ngo_pr8.jpeg" },
   { src: "/images/ngo_pr/ngo_pr.jpeg"},
 { src: "/images/ngo_pr/ngo_pr1.jpeg"},
   { src: "/images/ngo_pr/ngo_pr6.jpeg"},
   { src:   "/images/ngo_pr/ngo_pr3.jpeg"},
 { src: "/images/ngo_pr/ngo_pr4.jpeg"},
   { src: "/images/ngo_pr/ngo_pr5.jpeg"},
  { src:  "/images/ngo_pr/ngo_pr7.jpeg"},
  ...
  <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-10">
    ...
    >
      <h1 className="text-3xl sm:text-4xl lg:text-5xl font-lora font-semibold mb-4">
        Recognized and Encouraged – Our True Inspiration
      </h1>
      ...
      <section id="gallery" className="py-10 px-4 sm:px-6 lg:px-8 bg-cream-50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-2xl py-6 bg-lightgrey font-lora font-semibold text-navy-900 text-center mb-6">
            Our True  <a className="bg-navyblue text-white pl-6 pr-6 ">Inspiration</a> 
          </h2>
